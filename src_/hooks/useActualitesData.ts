...
const defaultActualitesData: ActualitesData = {
  ...
  articles: [
    ...
    },
    {
      ...
      extrait: 'Pour la Saint-Valentin, profitez de notre pack duo avec accrobranche + déjeuner romantique en forêt.',
      isEvenement: true,
  ...
  useEffect(() => {
    const fetchActualites = async () => {
      try {
        ...
        console.warn('⚠️ Actualités WordPress indisponibles, utilisation des valeurs par défaut:', err);
