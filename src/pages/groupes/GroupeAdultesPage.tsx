...
// Direction : festif, vibrant, warm gold, memories-first
import { Link } from 'react-router-dom';
import { motion } from 'framer-motion';
import {
  PartyPopper, Users, Calendar, Phone, ArrowRight, CheckCircle,
  Star, Clock, Heart, ChevronRight, Camera, Music,
  Sparkles, Zap, Gift, Crown, Flame, Mail, Trophy
} from 'lucide-react';
      ...
      <div className="relative z-10 container mx-auto px-6 pb-24 w-full">
        ...
        <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9, ease: [0.16, 1, 0.3, 1] }}>
          ...
          <h1 className="text-6xl md:text-8xl font-black text-white leading-[0.9] tracking-tight mb-6">
            Des souvenirs<br />
            dont vous<br />
            <span style={{ color: GOLD }}>parlerez 10 ans.</span>
          </h1>

          <p className="text-white/70 text-xl max-w-xl leading-relaxed mb-10">
            Finis les after-works mollassons. Les plus belles fêtes se vivent dans l'action, sous l'adrénaline et avec des rires qu'on entend depuis la vallée.
          </p>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          ...
          <h2 className="text-5xl font-black text-white mb-5 leading-tight">
            Votre fête mérite<br />
            <span style={{ color: GOLD }}>d'être inoubliable</span>
          </h2>
